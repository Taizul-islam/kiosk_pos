        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(child: Icon(Icons.lock_outline_rounded, size: size.width * 0.1, color: Colors.orange.shade700)),
            ),
            SizedBox(height: size.height * 0.03),
            Text('Staff Confirmation', style: TextStyle(fontSize: size.width * 0.05, fontWeight: FontWeight.bold)),
            SizedBox(height: size.height * 0.01),
            Text('Enter your PIN to confirm payment', style: TextStyle(fontSize: size.width * 0.035, color: Colors.grey.shade600)),
                  ...
                  children: List.generate(4, (index) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: _errorMessage.isNotEmpty ? Border.all(color: AppColors.error, width: 2) : null,
                      ),
                    );
                  }),
                ),
            ...
            if (_errorMessage.isNotEmpty) ...[
              ...
              Text(_errorMessage, style: TextStyle(color: AppColors.error, fontSize: size.width * 0.035)),
            ],
            SizedBox(height: size.height * 0.04),
            _buildKeypad(size),
            const Spacer(),
            TextButton(onPressed: () => Get.back(), child: Text('← Back', style: TextStyle(fontSize: size.width * 0.035, color: Colors.grey.shade500))),
            SizedBox(height: size.height * 0.03),
          ],
        ),
      ),
        ...
        return Row(
          ...
          children: row.map((key) {
            return Padding(
              ...
              child: SizedBox(
                width: size.width * 0.22, height: size.height * 0.08,
                child: Material(
                  color: key == '⌫' || key == '✕' ? Colors.grey.shade100 : Colors.white,
                  ...
                  child: InkWell(
                    ...
                    child: Center(
                      child: key == '⌫'
                          ? Icon(Icons.backspace_outlined, size: size.width * 0.06, color: Colors.grey.shade700)
                          : key == '✕'
                          ? Icon(Icons.close, size: size.width * 0.06, color: Colors.grey.shade700)
                          : Text(key, style: TextStyle(fontSize: size.width * 0.06, fontWeight: FontWeight.w600)),
                    ),
                  ),
                ),
              ),
